 ...
 *
 */
public class ArraySortableList<E> implements SortableCollection<E> {
    ...
    public ArraySortableList() {
        innerArray = (E[]) new Object[arrayCapacity = INCRM_INITIAL];
    }

    public ArraySortableList(int initialCapacity) {
        innerArray = (E[]) new Object[arrayCapacity = initialCapacity];
    }

    public ArraySortableList(Comparator<E> comparator) {
        this();
        this.comparator = comparator;
    }

    public ArraySortableList(Collection<E> collection) {
        this();
        addAll(collection);
    }

    public ArraySortableList(ArraySortableList<E> list) {
        this();
        addAll(list);
    }
